...
const STATUS_ICONS: Record<OrderStatus, React.ReactNode> = {
  ...
  processing: <RefreshCw size={12} className="text-blue-600" />,
  shipped: <Truck size={12} className="text-indigo-600" />,
  delivered: <CheckCircle size={12} className="text-green-600" />,
  cancelled: <Ban size={12} className="text-red-600" />,
};
