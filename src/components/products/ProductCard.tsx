    ...
    >
      <Link to={`/product/${encodeURIComponent(product.name)}`}  className="block">
        ...
        <div className="pt-4 space-y-1.5">
          {/* Category */}
          <p className="text-xs font-medium tracking-wider uppercase text-gold-400">
            {(product as any).categories?.name || 'Uncategorized'}
          </p>
          
          {/* Product Name */}
          <h3 className="font-serif text-base font-light text-neutral-200 group-hover:text-gold-400 transition-colors line-clamp-2">
            {product.name}
          </h3>
